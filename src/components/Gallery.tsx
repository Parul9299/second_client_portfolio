...
const videos = [
  {
    ...
    duration: "01:24",
    previewVideo:
      "https://www.pexels.com/download/video/16727459/",
    videoUrl:
      "https://www.pexels.com/download/video/16727459/",
  },
  {
    ...
    duration: "00:48",
    previewVideo:
      "https://www.pexels.com/download/video/15863504/",
    videoUrl:
      "https://www.pexels.com/download/video/15863504/",
  },
  {
    ...
    duration: "02:16",
    previewVideo:
      "https://www.pexels.com/download/video/29064708/",
    videoUrl:
      "https://www.pexels.com/download/video/29064708/",
  },
];
...
export function Gallery() {
  ...
  const categories = useMemo(() => {
    const existingCategories = allPortfolioItems.map(
      (item) => item.category,
    );
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#111111]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-12">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <Link
              to="/admin"
              className="font-condensed text-xs uppercase tracking-[0.2em] text-[#4af600]"
            >
              Admin
            </Link>
          </nav>
        ...
        {menuOpen && (
          <div className="border-t border-white/10 px-5 py-4 md:hidden">
            ...
            <Link
              to="/admin"
              className="block py-2 font-condensed text-xs uppercase tracking-[0.2em] text-[#4af600]"
            >
              Admin
            </Link>
          </div>
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <div className="max-w-sm pb-2 lg:mr-20">
              <p className="text-sm leading-7 text-[#999]">
                A visual archive of identities,
                campaigns, packaging, and digital
                experiences crafted with clarity,
            ...
            <div
              className={`${
                categoryDropdownOpen
                  ? "flex"
                  : "hidden"
              } absolute right-0 top-10 z-20 w-52 flex-col border border-white/10 bg-[#1a1a1a] p-2 sm:hidden`}
            >
          ...
          >
            ...
            <div className="flex flex-col justify-end p-7 sm:p-10">
              ...
              <p className="mt-6 text-sm leading-7 text-[#999]">
                A considered visual direction
                built to give the brand a distinct
