  ...
  return (
    ...
    >
      <h1 className="sr-only">
        Kabir Khan — Creative Art Director &amp; Graphic Designer
      </h1>
        ...
        >
          ...
          <div
            ...
            style={{
              width: "55%",
              background:
                "linear-gradient(to right, #111111 0%, rgba(17,17,17,0.6) 60%, transparent 100%)",
              zIndex: 3,
            }}
          />
          <div
          ...
          />
          <div
            className="absolute bottom-6 right-7 text-right"
            style={{ zIndex: 5 }}
          >
            <span className="text-white font-bold text-sm">Model</span>
            <span className="text-[#999] text-xs ml-2 font-light">
              Kabir Khan
            </span>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 sm:gap-5">
          <button
            className="text-white flex-shrink-0 p-1 md:hidden"
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <img
              ...
              className="
              w-[3rem] h-[3rem]
              min-[768px]:w-[2rem] min-[768px]:h-[2rem]
              min-[820px]:w-9 min-[820px]:h-9
              flex-shrink-0
              transition-transform duration-300
              group-hover:scale-110
            "
            />
            <span className="font-condensed text-white min-[780px]:text-[1.2rem] min-[819px]:text-[1rem] min-[820px]:text-lg font-bold tracking-wide">
              Kabir Khan
            </span>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8 lg:gap-10">
          {navLinks.map((item) => (
            <Link
              key={item.label}
              to={item.href}
              className="font-condensed text-[0.65rem] max-[860px]:text-[0.575rem] max-[915px]:text-[0.675rem] max-[980px]:text-[0.75rem] font-semibold tracking-[0.18em] transition-colors duration-200 hover:text-white"
              style={{
                color:
        ...
        <button
          className="hidden text-[#777] hover:text-white transition-colors flex-shrink-0"
          aria-label="Search"
        >
          <Search size={20} />
        </button>
      ...
      {menuOpen && (
        <div
          className="fixed left-0 right-0 z-40 bg-[#111111]/95 backdrop-blur-md border-b border-[#222] px-5 py-12 flex flex-col gap-4 md:hidden"
          style={{ top: 52 }}
        >
          {navLinks.map((item) => (
            <Link
      ...
      >
        ...
        >
          <span className="font-condensed text-[#666] text-xs font-bold tracking-widest">
            2026
          </span>
          <div style={{ width: 1, height: 28, background: "#444" }} />
          <span className="font-condensed text-[#888] text-xs tracking-[0.2em] uppercase">
        ...
        <div className="relative flex-1 flex flex-col justify-center my-auto">
          ...
          <div
            style={{
              ...
              animation:
                "lineExpand 0.6s cubic-bezier(0.16,1,0.3,1) 0.55s both",
            }}
          />
          ...
          >
            ...
            strengthen brands, and inspire action. Every design blends
            creativity, strategy, and precision to deliver lasting impact.
          </p>
        </div>
      ...
      <div className="md:hidden relative z-10 flex flex-col justify-end min-h-screen px-6 pt-28 pb-12">
        <div className="flex items-center gap-3 mb-4">
          <span className="font-condensed text-[#888] text-[11px] font-bold tracking-widest">
            2026
          </span>
          <div style={{ width: 1, height: 18, background: "#555" }} />
          <span className="font-condensed text-[#aaa] text-[10px] tracking-[0.18em] uppercase">
            Think · Design · Display
          </span>
        </div>
        ...
        <p
          className="text-[#ddd] text-[13px] leading-relaxed drop-shadow"
          style={{ maxWidth: 320 }}
        >
          I transform ideas into premium visual experiences that build trust,
        ...
        <div className="flex items-center gap-5 mt-6">
          {[FaTwitter, FaFacebook, FaInstagram].map((Icon, i) => (
            <Link
              key={i}
              to="#"
              className="text-[#aaa] hover:text-[#4af600] transition-colors"
            >
              <Icon size={18} />
            </Link>
          ))}
