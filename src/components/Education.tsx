      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {education.map((edu, i) => (
            <div
              key={i}
              className="card p-7 reveal relative overflow-hidden group"
        ...
        <div className="reveal mt-8">
          <div className="card p-8 border-[#4af600]/25 bg-gradient-to-r from-[#4af600]/8 to-transparent relative overflow-hidden">
            <div className="absolute -right-8 -top-8 w-40 h-40 rounded-full bg-[#4af600]/10 blur-3xl" />
            <div className="flex items-center gap-6 relative z-10">
              <div className="w-16 h-16 border-2 border-[#4af600]/30 flex items-center justify-center text-[#4af600] flex-shrink-0 animate-[pulseGreen_2.5s_ease-in-out_infinite]">
                <Award size={30} />
              </div>
              <div>
                <p className="section-label mb-2">Award & Recognition</p>
                <h3 className="font-condensed text-2xl font-bold text-white uppercase tracking-wide">Employee of the Year — 2024</h3>
